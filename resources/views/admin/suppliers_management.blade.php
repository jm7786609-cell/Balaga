...
@section('APP-SCRIPT')
    <script>
        ...
        function contactPersonFormatter(value, row) {
            return (row.user && row.user.full_name) || '<em class="text-muted">—</em>';
        }
        ...
        function editSupplier(id) {
            $.get(`/suppliers/${id}`)
                .done(res => {
                    ...
                    $('#edit_first_name').val(s.user.first_name);
                    $('#edit_middle_name').val(s.user.middle_name);
                    $('#edit_last_name').val(s.user.last_name);
            ...
            $('#table').bootstrapTable({
                columns: [{
                    ...
                    },
                    {
                        ...
                        formatter: 'contactPersonFormatter',
                    },
                    {
                        field: 'phone_number',
                        title: 'Phone',
